...
const paypalPayment_1 = __importDefault(require("./paypalPayment"));
const stripePremium_1 = __importDefault(require("./stripePremium"));
const premiumSuccess_1 = __importDefault(require("./premiumSuccess"));
...
router.use("/buyPremium", paypalPayment_1.default);
router.use("/premium/buy", stripePremium_1.default);
router.use('/premium/success', premiumSuccess_1.default);
